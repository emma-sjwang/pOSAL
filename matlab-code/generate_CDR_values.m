...
raw_result = '../results/Drishti-GS/test/OSAL_epoch100';
...
img_name, CDR_value
save(['../results/Drishti-GS/test/OSAL_epoch100/final_result' filesep img_name(1 : end - 4) '.mat'], 'CDR_value');
% imwrite(uint8(Seg_map), ['../results/Drishti-GS/test/OSAL_epoch100/final_result' filesep img_name(1 : end - 4) '.bmp']);
end
